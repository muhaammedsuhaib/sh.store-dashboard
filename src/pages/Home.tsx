...
export default function Home() {
  const features = [
    {
      ...
      description:
        "Easily manage and track all your orders in one place with real-time updates.",
    ...
    },
    {
      ...
      description:
        "Organize your products with categories, inventory tracking, and bulk operations.",
      color:
    ...
    },
    {
      ...
      description:
        "Manage customer relationships, segments, and communication effectively.",
      color:
    ...
    },
    {
      ...
      description:
        "Get insights into your sales, customer behavior, and business performance.",
    ...
    },
    {
      ...
      title: "Fast & Reliable",
      description:
        "Lightning-fast performance with 99.9% uptime guarantee for your store.",
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      {/* Hero Section */}
      <section className="relative bg-linear-to-br from-slate-900 via-blue-900 to-slate-800 text-white py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Welcome to <span className="text-blue-300">SH.SALE</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-slate-200 max-w-3xl mx-auto leading-relaxed">
              The ultimate solution for modern businesses — combining online
              growth with effortless in-store management in one powerful
              platform.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              Everything you need to manage your online store efficiently, from
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${feature.color} group-hover:scale-110 transition-transform duration-200`}
                >
                  {feature.icon}
                </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-linear-to-r from-slate-900 to-blue-900 dark:from-slate-800 dark:to-blue-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Transform Your Business?
          </h2>
          <p className="text-lg text-slate-200 mb-8 leading-relaxed">
            Join thousands of successful stores growing with SH.SALE — the
            all-in-one platform for e-commerce and in-store success.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/products"
      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                />
                <span className="text-xl font-bold text-white">SH.SALE</span>
              </div>
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-slate-400">
            <p>&copy; 2024 SH.SALE. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
